...
def writting_files(str_values):
    ...
    our_keys = list(keys.copy()[i] for i in [10])
    ...
    soil_parameters_names = ['pH10', 'pH20', 'pH30', 'pH40','pH50', 'pH60', 'pH70', 'pH80', 'pH90']
    ...
    pH10_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][0][our_keys[0]][0])
    pH20_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][1][our_keys[0]][0])
    pH30_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][2][our_keys[0]][0])
    pH40_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][3][our_keys[0]][0])
    pH50_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][4][our_keys[0]][0])
    pH60_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][5][our_keys[0]][0])
    pH70_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][6][our_keys[0]][0])
    pH80_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][7][our_keys[0]][0])
    pH90_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][8][our_keys[0]][0])
