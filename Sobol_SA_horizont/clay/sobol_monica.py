...
def writting_files(str_values):
    ...
    our_keys = list(keys.copy()[i] for i in [4])
    ...
    soil_parameters_names = ['clay10', 'clay20', 'clay30', 'clay40','clay50', 'clay60', 'clay70', 'clay80', 'clay90']
    ...
    clay10_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][0][our_keys[0]][0])
    clay20_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][1][our_keys[0]][0])
    clay30_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][2][our_keys[0]][0])
    clay40_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][3][our_keys[0]][0])
    clay50_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][4][our_keys[0]][0])
    clay60_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][5][our_keys[0]][0])
    clay70_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][6][our_keys[0]][0])
    clay80_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][7][our_keys[0]][0])
    clay90_value = str(site_data_copy['SiteParameters']['SoilProfileParameters'][8][our_keys[0]][0])
    

    file_name = str(clay10_value)+'_'+str(clay20_value)+'_'+str(clay30_value)+'_'+str(clay40_value)+str(clay50_value)\
    +'_'+str(clay60_value)+'_'+str(clay70_value)+'_'+str(clay80_value)+'_'+str(clay90_value)
